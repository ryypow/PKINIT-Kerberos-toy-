...
// --- TODO: may need to adjust sleep
	...
	shared_secret = ecdh_shared_secret_files(client_temp_sk_path, as_temp_pk_path, &shared_secret, &shared_secret_length);

	unsigned char *shared_secret_hashed = Hash_SHA256(shared_secret, &shared_secret_length);
